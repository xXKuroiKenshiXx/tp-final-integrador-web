...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function cargarTodosLosJugadores() {
    ...
    const jugadoresFiltrados = jugadores.filter(function(jugador) {
      return (
        (nombre === '' || jugador.nombre.toLowerCase().includes(nombre.toLowerCase())) &&
        (apellido === '' || jugador.apellido.toLowerCase.includes(apellido.toLowerCase)) &&
    ...
    jugadoresFiltrados.forEach(function(jugador,) {
      ...
      celdaNumero.textContent = jugador.id;
...
/* document.addEventListener("DOMContentLoaded", function() {
  ...
  function editarJugador(documento) {
    ...
    const jugadorModificado = {
      ...
      'dorsal': dorsalInput.value,
      'pieHabil': pieHabilSelect.value
    }
    ...
    jugadores.push(jugadorModificado)
